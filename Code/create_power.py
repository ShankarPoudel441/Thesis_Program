...
def arg_parse():
    ...
    parser.add_argument(
        ...
        help="location of the folder containing calib.yml and raw_data"
    )
...
if __name__=="__main__":
    ...
    for i in passes:
        ...
        normalized_power.to_csv(folder_location/f"normalized_power_pass_{i}.csv")
    ...
    all_data.to_csv(folder_location/f"normalized_all_power.csv")
